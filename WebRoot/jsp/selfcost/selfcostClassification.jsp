...
<head>
	...
	<script type="text/javascript" src="js/selfcost/selfcostClassification.js"></script>
	...
	<div class="content-wrapper ">
		<div id="bodymain" class="offhead">
			<div id="bodyright" class="offset2"><!-- Main -->
				<legend style="margin:0 auto;">成本要素分类导入</legend>
			...
			<div id="divBulkAdd" class="thumbnail" style="display:none;height: 95px;">
				<h5 align="left">成本要素分类批量导入</h5>
				<!-- <form action="PlanImport.action" enctype="multipart/form-data" method="post" class="form-horizontal"> -->
				<form action="selfcost!uploadClassification.action" enctype="multipart/form-data" method="post" class="form-horizontal">
					...
					<a href="download/classification.csv">下载批导模板</a>
				</form>
            </div>
