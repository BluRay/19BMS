...
<head>
	...
	<script type="text/javascript" src="js/production/productionBusSeats.js"></script>
</head>
<body>
	...
	<div class="content-wrapper ">
		<div id="bodymain" class="offhead">
			<div id="bodyright" class="offset2"><!-- Main -->
				<legend style="margin:0 auto;">车辆座位数</legend>
			...
			<table id="tableBusSeats" style="text-align:center;table-layout:fixed;font-size:12px" class="table table-bordered table-striped">
				<thead>
					<tr id="0">
...
<div class="modal" id="newModal" tabindex="-1" role="dialog" aria-hidden="true" style="display:none;">
    ...
    <div class="modal-body">
        <form id="  " class="form-horizontal">
            ...
            <div class="control-group">
                <label class="control-label" for="newOrderCode">*&nbsp;座位数</label>
                <div class="controls">
					<input style="height: 30px;" type="text" class="input-medium revise" placeholder="座位数..." id="new_bus_seats" onpaste="return false;" onkeyup="value=value.replace(/[^\d]/g,'')"/>
                </div>
            </div>
        </form>
    </div>
        ...
        <form id="  " class="form-horizontal">
           <div class="control-group">
            ...
            <div class="control-group">
                <label class="control-label" for="newOrderCode">*&nbsp;座位数</label>
                <div class="controls">
					<input style="height: 30px;" type="text" class="input-medium revise" placeholder="座位数..." id="edit_bus_seats" />
                </div>
            </div>
        </form>
    </div>
