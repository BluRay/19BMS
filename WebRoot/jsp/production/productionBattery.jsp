...
<head>
	...
	<script type="text/javascript" src="js/production/productionBattery.js"></script>
</head>
<body>
	...
	<div class="content-wrapper ">
		<div id="bodymain" class="offhead">
			<div id="bodyright" class="offset2"><!-- Main -->
				<legend style="margin:0 auto;">电池容量</legend>
			...
			<form id="form" class="well form-search">
				<table>
					...
					<tr>
						...
						<td><input style="height: 30px;" type="text" class="input-medium revise" data-provide="typeahead" data-items="30" data-source="" autocomplete="off" placeholder="订单编号..." 
	...
	<!-- 					<th style="text-align:center;">序号</th> -->
						...
						<th style="text-align:center;">电池容量</th>
...
<div class="modal" id="newModal" tabindex="-1" role="dialog" aria-hidden="true" style="display:none;">
    ...
    <div class="modal-body">
        <form id="  " class="form-horizontal">
            ...
            <div class="control-group">
                <label class="control-label" for="newOrderCode">*&nbsp;电池容量</label>
                <div class="controls">
					<input type="text" id="new_batteryCapacity" class="input-medium"/> AH
                </div>
            </div>
        ...
        <form id="  " class="form-horizontal">
           <div class="control-group">
            ...
            <div class="control-group">
                <label class="control-label" for="newOrderCode">*&nbsp;电池容量</label>
                <div class="controls">
					<input type="text" id="edit_batteryCapacity" class="input-medium"/> AH
                </div>
            </div>
        </form>
    </div>
