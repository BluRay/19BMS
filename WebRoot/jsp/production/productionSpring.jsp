...
<head>
	...
	<script type="text/javascript" src="js/production/productionSpring.js"></script>
</head>
<body>
	...
	<div class="content-wrapper ">
		<div id="bodymain" class="offhead">
			<div id="bodyright" class="offset2"><!-- Main -->
				<legend style="margin:0 auto;">弹簧片数</legend>
			...
			<table id="tableBus" style="text-align:center;table-layout:fixed;font-size:12px" class="table table-bordered table-striped">
				<thead>
					<tr id="0">
						...
						<th style="text-align:center;">弹簧片数</th>
...
<div class="modal" id="newModal" tabindex="-1" role="dialog" aria-hidden="true" style="display:none;">
    ...
    <div class="modal-body">
        <form id="  " class="form-horizontal">
            ...
            <div class="control-group">
                <label class="control-label" for="newOrderCode">*&nbsp;弹簧片数</label>
                <div class="controls">
					<input type="text" id="new_springNum" class="input-medium"/>
                </div>
            </div>
        ...
        <form id="  " class="form-horizontal">
           <div class="control-group">
            ...
            <div class="control-group">
                <label class="control-label" for="newOrderCode">*&nbsp;弹簧片数</label>
                <div class="controls">
					<input type="text" id="edit_springNum" class="input-medium"/>
                </div>
            </div>
        </form>
    </div>
