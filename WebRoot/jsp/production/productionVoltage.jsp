...
<head>
	...
	<script type="text/javascript" src="js/production/productionVoltage.js"></script>
</head>
<body>
	...
	<div class="content-wrapper ">
		<div id="bodymain" class="offhead">
			<div id="bodyright" class="offset2"><!-- Main -->
				<legend style="margin:0 auto;">额定电压</legend>
			...
			<form id="form" class="well form-search">
				<table>
					...
					<tr>
						...
						<td><input style="height: 30px;" type="text" class="input-medium revise"  data-provide="typeahead" data-items="30" data-source="" autocomplete="off" placeholder="订单编号..." id="search_order_no" /></td>						
			...
			<table id="tableBus" style="text-align:center;table-layout:fixed;font-size:12px" class="table table-bordered table-striped">
				<thead>
					<tr id="0">
						...
						<th style="text-align:center;">额定电压</th>
...
<div class="modal" id="newModal" tabindex="-1" role="dialog" aria-hidden="true" style="display:none;">
    ...
    <div class="modal-body">
        <form id="  " class="form-horizontal">
            ...
            <div class="control-group">
                <label class="control-label" for="newOrderCode">*&nbsp;额定电压</label>
                <div class="controls">
					<input type="text" id="new_voltage" class="input-medium"/>AH
                </div>
            </div>
        ...
        <form id="  " class="form-horizontal">
           <div class="control-group">
            ...
            <div class="control-group">
                <label class="control-label" for="newOrderCode">*&nbsp;额定电压</label>
                <div class="controls">
					<input type="text" id="edit_voltage" class="input-medium"/>V
                </div>
            </div>
        </form>
    </div>
