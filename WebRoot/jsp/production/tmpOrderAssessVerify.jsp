...
<script type="text/javascript" src="js/production/tmpOrderAssessVerify.js"></script>
</head>
<body>
	...
	<div class="content-wrapper ">
		<div id="bodymain" class="offhead">
			<div id="bodyright" class="offset2">
				<!-- Main -->
				<legend style="font-size:17px">临时工单评估工时审核</legend>
						...
						<table>
							...
							<tr>
								...
								<td><input type="button" class="btn btn-primary"
									...
									<input id="btnVerify" class="btn btn-info" value="审核" type="button">
								</td>
