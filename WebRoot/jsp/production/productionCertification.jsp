...
<body>
	...
	<div class="content-wrapper ">
		...
		<form id="form" class="well form-search">
			<table>
				<tr>
					<td>生产工厂: </td><td>订单编号: </td><td style="width:150px"></td><td>底盘上线日期：</td><td></td>
				</tr>
				<tr>
					...
					<input class="btn btn-danger" id="btnImport" value="打印" disabled="disabled" style="margin-left: 2px;" type="button">
		...
		*每行输入一个车号
		...
		<div style="margin-left:165px;margin-right:20px" class="offset4">
		<table id="tableCertification" style="text-align:center;table-layout:fixed;font-size:12px" class="table table-bordered table-striped">
			<thead>
				<tr id="0">
						...
						<!-- <th style="text-align:center;" >底盘日期</th> -->						
						<th style="text-align:center;padding-left:0px;padding-right:0px;" >整车生产日期</th>				
						<th style="text-align:center;padding-left:0px;padding-right:0px;" >颜色</th>						
						<th style="text-align:center;padding-left:0px;padding-right:0px;" >座位数</th>		
						<th style="text-align:center;padding-left:0px;padding-right:0px;" width="140px">合格证编号</th>
					</tr>
			</thead>
			<tbody>	
			</tbody>
