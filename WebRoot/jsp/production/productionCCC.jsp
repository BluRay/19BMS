...
<head>
	...
	<script type="text/javascript" src="js/production/productionCCC.js"></script>
</head>
<body>
	...
	<div class="content-wrapper ">
		<div id="bodymain" class="offhead">
			<div id="bodyright" class="offset2"><!-- Main -->
				<legend style="margin:0 auto;">3C证书、公告生效日期</legend>
			...
			<table id="tableBusCCC" style="text-align:center;table-layout:fixed;font-size:12px" class="table table-bordered table-striped">
				<thead>
					<tr id="0">
						...
						<th style="text-align:center;">CCC证书签发日期</th>
						<th style="text-align:center;">底盘公告生效日期</th>
						<th style="text-align:center;">整车公告生效日期</th>
...
<div class="modal" id="newModal" tabindex="-1" role="dialog" aria-hidden="true" style="display:none;">
    ...
    <div class="modal-body">
        <form id="  " class="form-horizontal">
            ...
            <div class="control-group">
                <label class="control-label" for="newOrderCode">*&nbsp;CCC证书签发日期</label>
                <div class="controls">
					<input type="text" id="new_bus_ccczs_date"
									class="input-medium"
									onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" />
                </div>
            </div>
            <div class="control-group">
                <label class="control-label" for="newOrderCode">*&nbsp;底盘公告生效日期</label>
                <div class="controls">
					<input type="text" id="new_bus_dpgg_date"
									class="input-medium"
									onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" />
                </div>
            </div>
            <div class="control-group">
                <label class="control-label" for="newOrderCode">*&nbsp;整车公告生效日期</label>
                <div class="controls">
					<input type="text" id="new_bus_zcgg_date"
									class="input-medium"
									onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" />
                </div>
            </div>
        ...
        <form id="  " class="form-horizontal">
           <div class="control-group">
            ...
            <div class="control-group">
                <label class="control-label" for="newOrderCode">*&nbsp;CCC证书签发日期</label>
                <div class="controls">
					<input type="text" id="edit_bus_ccczs_date"
									class="input-medium"
									onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" />
                </div>
            </div>
            <div class="control-group">
                <label class="control-label" for="newOrderCode">*&nbsp;底盘公告生效日期</label>
                <div class="controls">
					<input type="text" id="edit_bus_dpgg_date"
									class="input-medium"
									onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" />
                </div>
            </div>
            <div class="control-group">
                <label class="control-label" for="newOrderCode">*&nbsp;整车公告生效日期</label>
                <div class="controls">
					<input type="text" id="edit_bus_zcgg_date"
									class="input-medium"
									onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" />
                </div>
            </div>
