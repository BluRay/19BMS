...
<script type="text/javascript" src="js/production/tmpOrderAccept.js"></script>
</head>
<body>
	...
	<div class="content-wrapper ">
		<div id="bodymain" class="offhead">
			<div id="bodyright" class="offset2">
				<!-- Main -->
				<legend style="font-size:17px">验收临时工单</legend>
						...
						<table>
							...
							<tr>
								...
								<td><input type="button" class="btn btn-primary"
									...
									type="button" class="btn btn-success" id="btnAccept" value="验收"
