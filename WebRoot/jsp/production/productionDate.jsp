	...
	<div class="content-wrapper ">
		<div id="bodymain" class="offhead">
			<div id="bodyright" class="offset2"><!-- Main -->
				<legend style="margin:0 auto;">车辆生产日期</legend>
			...
			<table id="tableProductionDate" style="text-align:center;table-layout:fixed;font-size:12px" class="table table-bordered table-striped">
				<thead>
					<tr id="0">
...
<div class="modal" id="newModal" tabindex="-1" role="dialog" aria-hidden="true" style="display:none;">
    ...
    <div class="modal-body">
        <form id="  " class="form-horizontal">
            ...
            <div class="control-group">
                <label class="control-label" for="newOrderCode">*&nbsp;底盘生产日期</label>
                <div class="controls">
					<input type="text" id="new_dp_production_date"
									class="input-medium"
        ...
        <form id="  " class="form-horizontal">
           <div class="control-group">
            ...
            <div class="control-group">
                <label class="control-label" for="newOrderCode">*&nbsp;底盘生产日期</label>
                <div class="controls">
					<input type="text" id="edit_dp_production_date"
									class="input-medium"
									onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" />
                </div>
            </div>
			...
			<input type="hidden" id="edit_zcgg_date" />
			<input type="hidden" id="edit_ccczs_date" />
        </form>
    </div>
    <div class="modal-footer">
        <button class="btn" data-dismiss="modal" aria-hidden="true">关闭</button>
