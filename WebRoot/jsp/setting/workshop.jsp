...
<script type="text/javascript" src="js/setting/workshop.js"></script>
</head>
<body >
	...
	<div id="bodymain" class="offhead">
		<div id="bodyright" class="offset2">
			<!-- Main -->
			<legend style="margin: 0 auto;">车间</legend>
			<div style="margin: 0 auto;">
					...
					<table>
						...
						<tr>
							...
							<td><input type="text" class="input-medium revise"
								id="input_workshopName" /></td>
							<td>
							<select name="" id="input_deleteFlag" class="input-medium carType">
				...
				<table id="tableWorkshop" class="table table-condensed"
		...
		<div class="modal" id="newModal" tabindex="-1" role="dialog"
			...
			<div class="modal-body">
				<form id=" " class="form-horizontal">
					...
					<div class="control-group">
						<label class="control-label" for="newAssembCode">*&nbsp;车间名称</label>
						<div class="controls">
							<input type="text" class="input-medium" id="new_workshopName" />
						</div>
					</div>
					<div class="control-group">
						<label class="control-label" for="">&nbsp;车间代码</label>
						<div class="controls">
							<input type="text" class="input-medium" id="new_workshopCode" />
						</div>
					</div>
					<div class="control-group">
			...
			<div class="modal-body">
				<form id=" " class="form-horizontal">
					<div class="control-group">
						...
						<div class="controls">
							<select disabled="disabled" name="" id="edit_factory" class="input-medium carType">
							</select>
						</div>
					</div>
					<div class="control-group">
						<label class="control-label" for="">*&nbsp;车间名称</label>
						<div class="controls">
							<input type="text" class="input-medium" id="edit_workshopName" />
						</div>
					</div>
					<div class="control-group">
						<label class="control-label" for="">&nbsp;车间代码</label>
						<div class="controls">
							<input type="text" class="input-medium" id="edit_workshopCode" />
						</div>
					</div>
					<div class="control-group">
						<label class="control-label" for="">&nbsp;前置车间</label>
						<div class="controls">
							<select name="" id="edit_pre_workshopId" class="input-medium carType">
							</select>&nbsp;&nbsp;&nbsp;(生产扫描)
						</div>
					</div>
					<div class="control-group">
