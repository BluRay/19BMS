...
<script type="text/javascript" src="js/setting/workgroup.js"></script>
</head>
<body >
	...
	<div id="bodymain" class="offhead">
		<div id="bodyright" class="offset2">
			<!-- Main -->
			<legend style="margin: 0 auto;">车间班组</legend>
			<div style="margin: 0 auto;">
				...
				<form id="form" class="well form-search">
					<table>
						...
						<tr>
							...
							<td><input type="text" style="width:160px;" class="input-medium revise"
								id="input_workgroupName" /></td>
				...
				<table id="tableWorkgroup" class="table table-condensed"
		...
		<div class="modal" id="newModal" tabindex="-1" role="dialog"
			...
			<div class="modal-body">
				<form id=" " class="form-horizontal">
					...
					<div class="control-group">
						<label class="control-label" for="newWorkgroup">*&nbsp;班组</label>
						<div class="controls">
							<select name="" id="new_workgroup" class="input-medium carType">
							</select>
						</div>
					</div>
					<div class="control-group">
			...
			<div class="modal-body">
				<form id=" " class="form-horizontal">
					...
					<div class="control-group">
						...
						<div class="controls">
							<select name="" id="edit_workgroup" class="input-medium carType">
							</select>
						</div>
					</div>
					<div class="control-group">
