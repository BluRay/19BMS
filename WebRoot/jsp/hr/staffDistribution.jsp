	...
	<div class="content-wrapper ">
		<div id="bodymain" class="offhead">
			<div id="bodyright" class="offset2">
				<legend id="leg"><span id="staffListTitle"  style="font-size: 17px; margin-left:-2px;">班组成员承包单价</span>
						...
						<table style="width: 100%;margin: 0px;">						
							<tr >
								...
								<td style="width:130px;" >
									<input id="q_order" type="text" style="width:120px" class="input-medium"/>							
								</td>
								<td style="width:80px;" >
									工号/姓名：</td>				
								<td style="width:130px;" >
									<input id="q_staff" type="text" style="width:120px" class="input-medium"/>							
								</td>
							...
							<table id="staffTable" style="display:none;text-align:center;font-size:12px;table-layout:fixed;" class="table table-bordered table-striped" > <!--  -->
								<thead>
									<tr id="">
										...
										<th style="text-align:center;width:60px" >车间</th>
										<th style="text-align:center;width:180px">班组</th>
										<th style="text-align:center;">订单</th>
										<th style="text-align:center;width:70px" >工号</th>
										<th style="text-align:center;width:70px">姓名</th>
										<th style="text-align:center;width:70px">分配金额</th>
										<th style="text-align:center;width:90px">生效日期</th>
										<th style="text-align:center;width:70px">编辑人</th>
										<th style="text-align:center;width:90px">编辑时间</th>
										</tr>
								</thead>
								<tbody>	
								</tbody>
