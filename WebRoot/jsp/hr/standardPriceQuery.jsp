...
<script type="text/javascript" src="js/hr/standardPriceQuery.js"></script>
...
<body>
	...
	<div class="content-wrapper ">
		<div id="bodymain" class="offhead">
			...
			<legend id="leg"><span id="workgroupTitle"  style="font-size: 17px;">标准单价查询</span></legend>	
