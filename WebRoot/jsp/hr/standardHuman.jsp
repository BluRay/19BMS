...
<!-- add by wuxiao -->
<script type="text/javascript" src="js/hr/standardHuman.js"></script>
	...
	<div class="content-wrapper ">
		<div id="bodymain" class="offhead">
			...
			<legend id="leg">标准人力</legend>	
				...
				<div id="divImportFromFile" class="thumbnail" style="display:none;margin-left:235px;margin-bottom:10px;height:95px;margin-top:10px;">
					<h5 align="left">标准人力导入</h5>
					<!-- <form action="PlanImport.action" enctype="multipart/form-data" method="post" class="form-horizontal"> -->
					<form action="orgData!upload1.action" enctype="multipart/form-data" method="post" class="form-horizontal">
						...
						<a href="./download/standardHuman.xlsx">下载批导模板</a>
					</form>
            	</div>
				...
				<div style="margin-left:5px;float:left;width:55px;" id="busTypeDiv">
				...
				<div style="margin-left:60px;max-height: 386px;overflow:auto;" id="standardHumanDiv">
