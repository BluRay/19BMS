...
<script type="text/javascript" src="js/hr/tmpReport.js"></script>
	...
	<div class="content-wrapper ">
		<div id="bodymain" class="offhead">
			<div id="bodyright" class="offset2">
				<!-- Main -->
				<legend style="margin: 0 auto;">额外工时统计</legend>
				...
				<div style="margin-top: -10px;">
						<ul class="nav nav-tabs" id="new_tab" role="tablist"
							...
							<li class="active"><a href="#new_task1" data-toggle="tab"
								style="font-size: 14px; color: #333">临时派工单维度</a></li>
				...
				<div id="workDimensionDiv" style="float:left;padding-bottom:40px; width: 100%;overflow:auto;max-height:335px">
