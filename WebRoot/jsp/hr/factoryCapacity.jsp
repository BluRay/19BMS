...
<script type="text/javascript" src="js/hr/factoryCapacity.js"></script>
<style type="text/css">
.section-head {
	...
	<div class="content-wrapper ">
		<div id="bodymain" class="offhead">
			<div id="bodyright" class="offset2">
				<!-- Main -->
				<legend style="margin: 0 auto;">工厂产能维护</legend>
			...
			<div class="modal" id="newModal" tabindex="-1" role="dialog" aria-hidden="true" style="display:none;">
			    ...
			    <div class="modal-body">
			        <form id="  " class="form-horizontal">
			            ...
			            <div class="control-group">
			                <label class="control-label" for="newCapacity">*&nbsp;产能</label>
			                <div class="controls">
			                    <input type="text" id="newCapacity" placeholder="只能是整数..." class="input-medium" onkeyup="value=value.replace(/[^\d]/g,'')" onpaste="return false;" />
			                </div>
			            </div>
			            <!-- <div class="control-group">
