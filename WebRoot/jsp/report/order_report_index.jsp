						...
						<ul class="thumbnails">
							<li class="span6">
							  	<div class="thumbnail" style="width:100%;height:240px">
							  		<a href="orderReport!orderInProcessReport.action?flag=view"><img alt="" src="<%=basePath%>/images/order_report_1.png" style="width:100%;height:230px"></a>
							  	</div>
							</li>
							<li class="span6">
								<div class="thumbnail" style="width:100%;height:240px;color:pink">
									<a href="orderReport!factoryOrderProcessReport.action?flag=view" class="js-sub-menu-toggle">
			...
			<div class="row-fluid" style="margin:auto;width:1000px;height:240px;">
					<div class="span12" >
						<ul class="thumbnails">
							<li class="span6">
							  	<div class="thumbnail" style="width:100%;height:240px;color:pink">
							  	<a href="planReport!workshopRateReport.action?flag=view" class="js-sub-menu-toggle">
							  		<img alt="" src="<%=basePath%>/images/order_report_3.png" style="width:100%;height:230px">
							  	</a>
							  	</div>
							</li>
							<li class="span6">
								<div class="thumbnail" style="width:100%;height:240px;color:pink">
								<a href="planReport!factoryRateReport.action?flag=view" class="js-sub-menu-toggle">
							  		<img alt="" src="<%=basePath%>/images/order_report_4.png" style="width:100%;height:230px">
							  	</a>	
							  	</div>
							</li>							
						</ul>
