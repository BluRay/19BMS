						...
						<ul class="thumbnails">
							<li class="span6">
							  	<div class="thumbnail" style="width:100%;height:240px">
							  		<a href="ecnReport!ecnTimeReport.action?flag=view">
							  		<img alt="" src="<%=basePath%>/images/ecn_report_1.png" style="width:100%;height:230px"></a>
							  	</div>
							</li>
							<li class="span6">
								<div class="thumbnail" style="width:100%;height:240px;color:pink">
									<a href="ecnReport!ecnBusTypeReport.action?flag=view">
							  			<img alt="" src="<%=basePath%>/images/ecn_report_2.png" style="width:100%;height:230px">
							  		</a>
							  	</div>
							</li>							
						</ul>
			...
			<div class="row-fluid" style="margin:auto;width:1000px;height:240px;">
					<div class="span12" >
						<ul class="thumbnails">
							<li class="span6">
							  	<div class="thumbnail" style="width:100%;height:240px;color:pink">
							  	<a href="ecnReport!ecnOrderScheduleReport.action?flag=view">
							  		<img alt="" src="<%=basePath%>/images/ecn_report_3.png" style="width:100%;height:230px"></a>
							  	</div>
							</li>					
						</ul>
				</div>
