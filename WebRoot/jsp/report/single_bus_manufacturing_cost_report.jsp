...
<head>
	...
	<script type="text/javascript" src="js/report/single_bus_manufacturing_cost_report.js"></script>
	...
	<div class="content-wrapper ">
		<div id="bodymain" class="offhead">
			<div id="bodyright" class="offset2"><!-- Main -->
				<legend style="margin:0 auto;">各车间单车制造费用
                </legend>
			</div>
			...
			<table id="tableContainer" class="display" style="max-width: 100%;min-width: 500px;margin: auto;" align="center" >
				<thead>
					<tr>
						<th>机器费用</th>
						<th>其他材料消耗</th>
