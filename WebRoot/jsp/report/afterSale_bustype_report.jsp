...
<head>
	...
	<script type="text/javascript" src="js/report/afterSale_bustype_report.js"></script>
	...
	<div class="content-wrapper ">
		<div id="bodymain" class="offhead">
			<div id="bodyright" class="offset2"><!-- Main -->
				<legend style="margin:0 auto;">车型售后问题
                </legend>
			</div>
			...
			<div id="containerReport" style="max-width: 1000px;min-width: 500px;margin: auto;width: 950px;" align="center">
