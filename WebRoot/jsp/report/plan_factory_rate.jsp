...
<head>
	...
	<script type="text/javascript" src="js/report/factory_plan_rate.js"></script>
	...
	<div class="content-wrapper ">
		<div id="bodymain" class="offhead">
			<div id="bodyright" class="offset2"><!-- Main -->
				<legend style="margin:0 auto;">计划达成率
			...
			<div style="max-width: 1200px;min-width: 600px;padding-left: 20px;text-align: center;" ><br/>
				<table align="center">
					<tr>
						...
						<td>&nbsp;&nbsp;<input type="radio" name="xx" class="radio" id="week" checked="checked" value="W" style="margin-left: 2px;" />本周
						&nbsp;&nbsp;<input type="radio" name="xx" class="radio" id="month" value="M" style="margin-left: 2px;" />本月
						&nbsp;&nbsp;<input type="radio" name="xx" class="radio" id="year" value="Y" style="margin-left: 2px;" />本年
						</td>
					</tr>
				</table>
			</div>
