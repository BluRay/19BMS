		...
		<div id="bodymain" class="offhead">
			<div id="bodyright" class="offset2">
				...
				<ul class="nav nav-pills" role="tablist" style="height: 30px">
					<li role="presentation" class="active" id="dailyReport_li"><a
						href="#dailyReport" aria-controls="dailyReport" role="tab"
						data-toggle="tab">生产日报表</a></li>
					<li role="presentation" id="chartReport_li"><a href="#chartReport"
						aria-controls="chartReport" role="tab" data-toggle="tab">图形报表</a></li>
				</ul>
				<div class="tab-content">
					<div role="tabpanel" class="tab-pane active" id="dailyReport">
					...
					<div role="tabpanel" class="tab-pane" id="chartReport" >
						...
						<div id="chartContainer1" class="span5" style="height:300px"></div>
						<div id="chartContainer2" class="span5" style="height:300px"></div>
