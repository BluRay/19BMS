...
<script type="text/javascript" src="js/report/wprocess_problem_report.js"></script>
</head>
<body>
	...
	<div class="content-wrapper ">
		<div id="bodymain" class="offhead">
			<div id="bodyright" class="offset2">
				<legend style="margin: 0 auto;">车间制程问题报表</legend>
				...
				<table id="tableContainer" class="table table-bordered"
					style="display: none;width: 1080px;">
					<thead>
					</thead>
					<tbody>
			...
			<input type="hidden" id="factory_self"
				...
				value="<s:property value='user.department'></s:property>" />
		</div>
	</div>
</body>
</html>