...
<script type="text/javascript" src="js/quality/oc_record_detail.js"></script>
</head>
<body >
		...
		<div id="bodymain" class="offhead">
			<div id="bodyright" class="offset2">
				...
				<input type="hidden" id="q_factoryId"
					value="<s:property value="ocHeader.factoryId"/>"> <input
					type="hidden" id="q_busNo"
					value="<s:property value="ocHeader.busNo"/>">

				<div role="tabpanel">
					<!-- Nav tabs -->
					<ul class="nav nav-pills" role="tablist" style="height: 30px">
						<li role="presentation" style="display:none" id="welding_li"><a
							href="#welding" aria-controls="welding" role="tab"
							data-toggle="tab" onclick="generateTable('焊装')">焊装</a></li>
