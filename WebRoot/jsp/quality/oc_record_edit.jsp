...
<script type="text/javascript" src="js/quality/oc_record_edit.js"></script>
</head>
<body >
		...
		<div id="bodymain" class="offhead">
			<div id="bodyright" class="offset2">
				...
				<input type="hidden" id="q_factoryId"
					value="<s:property value="ocHeader.factoryId"/>">
				...
				<div role="tabpanel" >
					...
					<!-- Tab panes -->
					<form action="prodTrackIn!updateRecord.action" method="post" id="saveForm" class="form-search">
