...
<script type="text/javascript" src="js/quality/oc_record_add.js"></script>
</head>
<body>
	...
	<div id="bodymain" class="offhead">
		...
		<div id="bodyright" class="offset2">
			<!-- Main -->
			<legend style="margin: 0 auto;">订单配置与一致性新增</legend>
			<div style=" margin: 0 auto;">
				...
				<form id="saveForm" method="post" action="prodTrackIn!addRecord.action" class="form-search">
