...
<script type="text/javascript" src="js/quality/test_tpl_detail_edit.js"></script>
</head>
<body >
				...
				<form id="form" class="well form-search">
					<table>
						<tr>
							...
							<s:if test="testTplHeader.isDraft==0"><input type="checkbox" id="isDraft" checked/></s:if>
