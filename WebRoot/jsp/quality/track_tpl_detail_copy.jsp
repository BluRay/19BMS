...
<script type="text/javascript" src="js/quality/track_tpl_detail_copy.js"></script>
</head>
<body >
					...
					<div class="modal-body" style="overflow-y:visible">
						<div class="control-group">						
							<div class="controls" id="">
								零部件：<input type="text" id="new_select" class="input-large carType"></input>
