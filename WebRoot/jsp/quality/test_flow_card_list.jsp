...
<script type="text/javascript" src="js/quality/test_flow_card_list.js"></script>
</head>
<body id="testRecordIn">
	...
	<div id="bodymain" class="offhead">
		...
		<div id="bodyright" class="offset2">
			<!-- Main -->
			<legend style="margin: 0 auto;">检验流程卡</legend>
			<div style=" margin: 0 auto;">
				...
				<form id="form" class="well form-search">
					<table>
						...
						<tr>
							<td><select id="q_factory" class="input-small">
								<option value="">请选择</option>
							</select>
							</td>
							<td><select id="q_workshop" class="input-small">
								<option value="">请选择</option>
							</select></td>
