...
<script type="text/javascript" src="js/quality/oc_tpl_detail_edit.js"></script>
</head>
<body >
				...
				<div class="modal" id="editModal" tabindex="-1" role="dialog"
					...
					<div class="modal-body" style="overflow-y:visible">
						<div class="control-group">						
							...
							<br/>
							供应商：<input type="text" id="edit_input" class="input-large carType"></input>
