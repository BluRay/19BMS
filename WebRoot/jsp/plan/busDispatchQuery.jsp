...
<script type="text/javascript" src="js/plan/busDispatchQuery.js"></script>
</head>
<body >
	...
	<div id="bodymain" class="offhead">
		...
		<div id="bodyright" class="offset2">
			<!-- Main -->
			<legend style="margin: 0 auto;">发车查询</legend>
				<br />
				<div>
				...
				<form id="form" class="well form-search">
					<table>
						...
						<tr>
							<td><input type="text" class="input-medium revise" id="input_order" placeholder="生产订单..."/></td>
