		...
		<div id="bodymain" class="offhead">
			<div id="bodyright" class="offset2"><!-- Main -->
				...
				<span class="pull-right">
                	<a class="notPrintable" href="/19bms/plan!month.action"><i class="fa fa-link"></i>&nbsp;工厂月计划</a>
                &nbsp;&nbsp;
                	<a class="notPrintable" href="#"><i class="fa fa-link"></i>&nbsp;计划调整记录</a>
                &nbsp;&nbsp;
                	<a class="notPrintable" href="/19bms/plan!plansearch.action"><i class="fa fa-link"></i>&nbsp;计划达成情况</a>
                </span>
                </legend>
			</div>
