...
<head>
	...
	<script type="text/javascript" src="js/aftersale/improveReport.js"></script>
...
<div id="bodyright" class="offset2"><!-- Main -->
	<legend style="margin:0 auto;">改善报告</legend>
		...
		<form id="form" class="well form-search">
			<table>
				...
				<tr>
					...
					<td><input style="height: 30px;" type="text" class="input-medium revise" id="search_customer_name" /></td>
					<td><select name="" id="status" class="input-medium carType">
...
<!-- NEW MODAL -->
			...
			<div class="modal-body">
				<form id="editImproveSalesProblems" enctype="multipart/form-data" method="post" action="afterSale!editImproveSalesProblems.action" class="form-horizontal">
					...
					<div class="control-group">
						...
						<div class="controls">
							<select name="improveSalesProblems.fault_level_id" id="new_fault_level_id" class="input-medium carType">
							...
							<input type="hidden" name="improveSalesProblems.severity_level" id="new_severity_level" />
						</div>
					</div>
					<div class="control-group">
						<label class="control-label" for="new_provisional_measures">&nbsp;临时措施</label>
						<div class="controls">
							<textarea class="input-xlarge"  name="improveSalesProblems.provisional_measures" id="new_provisional_measures" rows="3"></textarea>
						</div>
					</div>
					<div class="control-group">
						<label class="control-label" for="new_reason">&nbsp;根本原因</label>
						<div class="controls">
							<textarea class="input-xlarge"  name="improveSalesProblems.reason" id="new_reason" rows="4"></textarea>
						</div>
					</div>
					<div class="control-group">
						<label class="control-label" for="new_improved_measure">&nbsp;改进措施</label>
						<div class="controls">
							<textarea class="input-xlarge"  name="improveSalesProblems.improved_measure" id="new_improved_measure" rows="3"></textarea>
						</div>
					</div>
					<div class="control-group">
						<label class="control-label" for="new_verify">&nbsp;执行和验证</label>
						<div class="controls">
							<textarea class="input-xlarge"  name="improveSalesProblems.verify" id="new_verify" rows="3"></textarea>
						</div>
					</div>
					<div class="control-group">
						<label class="control-label" for="new_standard">&nbsp;预防和标准化</label>
						<div class="controls">
							<textarea class="input-xlarge"  name="improveSalesProblems.standard" id="new_standard" rows="4"></textarea>
						</div>
					</div>				
					<div class="control-group">
						...
						<div style="padding-top: 3px;" class="controls">
							<input type="file" name="beforePhoto" id="beforePhoto" style="height: 30px;width:180px">
						</div>
					</div>
					<div class="control-group">
						...
						<div style="padding-top: 3px;" class="controls">
							<input type="file" name="afterPhoto" id="afterPhoto" style="height: 30px;width:180px">
						</div>
					</div>
					<div class="control-group">
						<label class="control-label" for="new_attachment">&nbsp;附件</label>
						<div style="padding-top: 3px;" class="controls">
							<a id="view_attachment" href="#" target="_blank"></a>&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="file" name="attachment" id="attachment" style="height: 30px;width:180px">
						</div>
					</div>
				</form>
			</div>
			<div class="modal-footer">
				<button class="btn" data-dismiss="modal" id="btnAddClose" aria-hidden="true">关闭</button>
		...
		<div class="modal" id="viewModal" tabindex="-1" role="dialog"
			...
			<div class="modal-footer">
				<button class="btn" data-dismiss="modal" id="btnProblemClose" aria-hidden="true">关闭</button>
			</div>
		</div>
	</div>
	</div>
