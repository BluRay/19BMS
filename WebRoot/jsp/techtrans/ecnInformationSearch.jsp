...
<body >
	...
	<span class="pull-right">
                	<a class="notPrintable" href="swrNotice!showTechTransList.action"><i class="fa fa-link"></i>&nbsp;技改工时</a>
    </span>
	</legend>
	<div role="tabpanel" class="tab-pane active" id="welding">
			<ul class="nav nav-pills" role="tablist" style="height: 30px">
					<li role="presentation" class="active" >
							<a id="taskFollowing"  aria-controls="#taskFollowing" role="tab" data-toggle="tab">技改任务</a>
							
					</li>
					<li role="presentation" >
							<a id="carFollowing"  aria-controls="#carFollowing" role="tab" data-toggle="tab">车辆技改信息</a></li>
			</ul>
	</div>
	<div id="taskFollow">
