...
<div class="navbar navbar-fixed-top" id="bmsHead">
	<div class="navbar-inner">
		<div style="width:1200px" class="container">
			<a class="brand" href="<%=basePath%>">BMS</a>
			<div class="nav-collapse" style="margin-top: 2px;">
				<ul style="margin-left:80px" id="headNav" class="nav">
					<li id="headTechnologyLi">
						<a href="<%=basePath%>order!ordersearch.action" data-toggle="tooltip" data-placement="bottom" title="<s:text name="order"/>"><i class="fa fa-list-alt"></i>&nbsp;<s:text name="order"></s:text></a>
					</li>
					<li id="headTechnologyLi">
						<a href="<%=basePath%>plan!index.action" data-toggle="tooltip" data-placement="bottom" title="计划"><i class="fa fa-calendar"></i>&nbsp;计划</a>
					</li>
					...
					<li id="headCostLi">
						<a href="<%=basePath%>afterSale!queryAfterSaleProblems.action" data-toggle="tooltip" data-placement="bottom" title="售后"><i class="fa fa-futbol-o"></i>&nbsp;售后</a>
					</li>
        		...
        		<ul class="nav pull-right">
         			 ...
         			 <li>
            			<a href="<%=basePath%>logout" rel="tooltip" data-toggle="tooltip" data-placement="bottom" title="注销"><i class="fa fa-sign-out"></i></a>
         			 </li>
        		</ul>
			</div>
		</div>
