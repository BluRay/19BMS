var status_arr={"0":"已创建","1":"已审批","2":"已分配","3":"已评估","4":"已验收","5":"已完成"};
...
function ajaxQuery(targetPage){
	...
	var conditions = "{orderNo:'" + orderNo+"',applyDateStart:'"+applyDateStart+"',actionType:'approve"+
...
function ajaxEdit(conditions){	
	var targetPage=$("#cur").attr("page")||1;
	$.ajax({
		url: "tempOrder!approveOrder.action",
	    dataType: "json",
		type: "get",
	    data: {
	    	"conditions": conditions
