		...
		success : function(response) {
			...
			$.each(response.data, function(index, value) {
				...
				if((value.workshop_name == "焊装")&&(value.line == "A线")){
					...
					$("#node-welding-HA"+WeldingCountA).attr('onclick','').click(eval(function(){window.location.href='production!exception.action?factory_id='+$("#search_factory").val()+'&workshop_id='+value.workshop_id+'&line_id='+value.line_id+'&process_id='+value.id}));
				...
				if((value.workshop_name == "焊装")&&(value.line == "B线")){
					...
					$("#node-welding-HB"+WeldingCountB).attr('onclick','').click(eval(function(){window.location.href='production!exception.action?factory_id='+$("#search_factory").val()+'&workshop_id='+value.workshop_id+'&line_id='+value.line_id+'&process_id='+value.id}));
				...
				if(value.workshop_name == "玻璃钢"){
					...
					$("#node-fiberglass-HA"+FiberglassCountA).attr('onclick','').click(eval(function(){window.location.href='production!exception.action?factory_id='+$("#search_factory").val()+'&workshop_id='+value.workshop_id+'&line_id='+value.line_id+'&process_id='+value.id}));
				...
				if((value.workshop_name == "涂装")&&(value.line == "A线")){
					...
					$("#node-painting-HA"+PaintingCountA).attr('onclick','').click(eval(function(){window.location.href='production!exception.action?factory_id='+$("#search_factory").val()+'&workshop_id='+value.workshop_id+'&line_id='+value.line_id+'&process_id='+value.id}));
				...
				if((value.workshop_name == "底盘")&&(value.line == "A线")){
					...
					$("#node-chassis-HA"+ChassisCountA).attr('onclick','').click(eval(function(){window.location.href='production!exception.action?factory_id='+$("#search_factory").val()+'&workshop_id='+value.workshop_id+'&line_id='+value.line_id+'&process_id='+value.id}));
				...
				if((value.workshop_name == "底盘")&&(value.line == "B线")){
					...
					$("#node-chassis-HB"+ChassisCountB).attr('onclick','').click(eval(function(){window.location.href='production!exception.action?factory_id='+$("#search_factory").val()+'&workshop_id='+value.workshop_id+'&line_id='+value.line_id+'&process_id='+value.id}));
				...
				if((value.workshop_name == "总装")&&(value.line == "A线")){
					...
					$("#node-assembly-HA"+AssemblyCountA).attr('onclick','').click(eval(function(){window.location.href='production!exception.action?factory_id='+$("#search_factory").val()+'&workshop_id='+value.workshop_id+'&line_id='+value.line_id+'&process_id='+value.id}));
				...
				if((value.workshop_name == "总装")&&(value.line == "B线")){
					...
					$("#node-assembly-HB"+AssemblyCountB).attr('onclick','').click(eval(function(){window.location.href='production!exception.action?factory_id='+$("#search_factory").val()+'&workshop_id='+value.workshop_id+'&line_id='+value.line_id+'&process_id='+value.id}));
				...
				if((value.workshop_name == "调试区")&&(value.line == "A线")){
					...
					$("#node-shakedowntest-HA"+ShakedowntestCountA).attr('onclick','').click(eval(function(){window.location.href='production!exception.action?factory_id='+$("#search_factory").val()+'&workshop_id='+value.workshop_id+'&line_id='+value.line_id+'&process_id='+value.id}));
				...
				if((value.workshop_name == "检测线")&&(value.line == "A线")){
					...
					$("#node-testline-HA"+TestlineCountA).attr('onclick','').click(eval(function(){window.location.href='production!exception.action?factory_id='+$("#search_factory").val()+'&workshop_id='+value.workshop_id+'&line_id='+value.line_id+'&process_id='+value.id}));
				...
				if((value.workshop_name == "成品库")&&(value.line == "A线")){
					...
					$("#node-warehouse-HA"+WarehouseCountA).attr('onclick','').click(eval(function(){window.location.href='production!exception.action?factory_id='+$("#search_factory").val()+'&workshop_id='+value.workshop_id+'&line_id='+value.line_id+'&process_id='+value.id}));
