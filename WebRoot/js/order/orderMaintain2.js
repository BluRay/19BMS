...
$(document).ready(function () {	
	...
	$("#editFactoryOrder").click( function (argument) {
		...
		"<td>" + select_str + "</td>" +
		"<td><input type='text' style='width:40px' disabled='disabled' class='input-small orderNum' value='0' id='production_qty2'/></td>" +
		"<td><input type='text' style='width:40px' class='input-small busNum' value='0' id='busnum_start2'/></td>" +
		"<td><input type='text' style='width:40px' class='input-small busNum' value='0' id='busnum_end2'/></td>" +
		"<td><input type='text' style='width:40px;display:none' class='input-small' value='0' id='minbusnum'/></td>" +
		"<td><input type='text' style='width:40px;display:none' class='input-small' value='0' id='maxbusnum'/></td>" +
		"</tr>";
	...
	$("#addFactoryOrder").click( function (argument) {
		var paramHtml="<tr><td><button type=\"button\" class=\"close\" aria-label=\"Close\" ><span aria-hidden=\"true\">&times;</span></button></td>" +
		"<td>" + select_str + "</td>" +
		"<td><input type='text' style='width:60px' disabled='disabled' class='input-small orderNum' value='0' id='production_qty1'/></td>" +
		"<td><input type='text' style='width:60px' class='input-small busNum' value='0' id='busnum_start1'/></td>" +
		"<td><input type='text' style='width:60px' class='input-small busNum' value='0' id='busnum_end1'/></td>" +
		"</tr>";
	...
	function ajaxAdd (argument) {
		...
		if (factoryNum != totleNum){
			alert("产地分配数量之和与订单总数量不相等！订单流水分配有误，请确保流水从1开始且连续！");
			$("#btnAddConfirm").removeAttr("disabled");
			return false;
		}
		if (max_num != totleNum){
		...
		success: function (response) {
			if(response.success){
				...
				$.each(response.data,function(index,value){
					...
					//"<td>" + select_str + "</td>" +
					"<td>" + select_str1 + "<option value='"+ value.factory_id + "'> "+ value.factory_name + "</option>" + select_str2 + "</td>" +
					"<td><input type='text' style='width:60px' disabled='disabled' class='input-small orderNum' value='"+value.production_qty+"' id='production_qty2'/></td>" +
					"<td><input type='text' style='width:60px' class='input-small busNum' value='"+value.busnum_start+"' id='busnum_start2'/></td>" +
					"<td><input type='text' style='width:60px' class='input-small busNum' value='"+value.busnum_end+"' id='busnum_end2'/></td>" +
					...
					"</tr>";
					$(paramHtml).appendTo("#edit_factoryOrder_parameters");
					$(paramHtml).data("minbusnum",value.minbusnum);
					$(paramHtml).data("maxbusnum",value.maxbusnum);
