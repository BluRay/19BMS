...
$(".treemenu").clickToggle(function(e){
	var span=$(e.target).parent().find(".pull-right.fa");
	//alert($(e.target).html());
	...
	if($(span).hasClass("fa-angle-up")){
		$(span).removeClass("fa-angle-up").addClass("fa-angle-down");
	}else if($(span).hasClass("fa-angle-down")){
		$(span).removeClass("fa-angle-down").addClass("fa-angle-up");
	}
});
$('.main-menu > li > a > .text').animate({
	...
	/*$('.sidebar-minified').find('i.fa-angle-right').toggleClass('fa-angle-left');*/
	...
	$('.js-toggle-minified').clickToggle(
		...
		function() {
			...
			$('.main-menu > li > a > .pull-right').animate({
				opacity: 0
			}, 200);
			//alert("right")
		...
		function() {
			...
			$(".in").css("height","auto");
			//$('.sidebar-minified').find('i.fa-angle-right').toggleClass('fa-angle-left');
			var ele=$('.sidebar-minified').find('i.fa-angle-right');
			$(ele).removeClass('fa-angle-right').addClass('fa-angle-left');
		}
