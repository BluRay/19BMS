$(document).ready(function() {
	...
	$(".fa-files-o").live("click",function(e){
		...
		var headerId=$(tr).data("id");
		var workshop=$(tr).find("td").eq(1).html();
		var busType=$(tr).find("td").eq(0).html();
		window.open("trackTpl!showTplDetailCopyPage.action?tplHeader.id="+headerId+"&tplHeader.busType="+busType+
				"&tplHeader.workshop="+workshop+"&tplHeader.tplType=车型","_self");
	});
