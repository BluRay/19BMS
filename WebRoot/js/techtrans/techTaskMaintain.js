	...
	$.ajax({
	    ...
	    success:function(response){
    		...
    		$.each(response.data,function(index,value){
    			...
    			$("<td />").html(value.tech_order_type).appendTo(tr);
    			$("<td />").html(value.tech_order_no).appendTo(tr);
    			$("<td />").html(value.tech_order_file).appendTo(tr);
    			$("<td />").html(value.tech_date).appendTo(tr);
    			$("<td />").html(value.duty_date).appendTo(tr);
    			$("<td />").html(value.major_change).appendTo(tr);
    			$("<td />").html(value.custom_change).appendTo(tr);
    			$("<td />").html(value.custom_change_file).appendTo(tr);
    			$("<td />").html(value.repeat_change).appendTo(tr);
    			$("<td />").html(value.tech_type).appendTo(tr);
