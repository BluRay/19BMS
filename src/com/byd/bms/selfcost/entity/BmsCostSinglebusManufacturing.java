...
public class BmsCostSinglebusManufacturing {
	private int id;
	private int factory_id;
	private int cost_department_id;
	private String cost_month;
	private String real_offline_qty;
	private String assess_offline_qty;
	...
	private String eliminate_abnormal_total;
	...
	public String getReal_offline_qty() {
		return real_offline_qty;
	}
	public void setReal_offline_qty(String real_offline_qty) {
		this.real_offline_qty = real_offline_qty;
	}
	public String getAssess_offline_qty() {
		return assess_offline_qty;
	}
	public void setAssess_offline_qty(String assess_offline_qty) {
		this.assess_offline_qty = assess_offline_qty;
	}
	...
	public String getEliminate_abnormal_total() {
		return eliminate_abnormal_total;
	}
	public void setEliminate_abnormal_total(String eliminate_abnormal_total) {
		this.eliminate_abnormal_total = eliminate_abnormal_total;
	}
